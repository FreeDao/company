...
;(function($, undefined) {
	...
	function Modal(options) {
		...
		this.$modal = $(this.options.target,top.document).attr('class', 'modal fade').hide();
		var self = this;
	...
	$.fn[pluginName].defaults = {
		...
		,appendTo: top.document.body	// where should the modal be appended to (default to document.body). Added for unit tests, not really needed in real life.
