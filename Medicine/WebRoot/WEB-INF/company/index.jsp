...
<h1 class="page-title">&nbsp; 
				...
				<div class="widget widget-table">
					...
					<div style="margin-bottom: 5px;">
						<a data-trigger="modal" href="bg/company!goAddOrEdit" data-title="添加特药企业资讯" class="btn btn-primary"><i class="icon-plus" ></i>添加</a>
					</div>
								...
								<table class="table table-bordered table-hover">
									...
									<c:forEach items="${pu.data }" var="pd">
										<tr>
											...
											<td>${pd.source }</td>
											<td>
											<a class="btn" data-trigger="modal" href="bg/company!goAddOrEdit?company.id=${pd.id }" data-title="修改特药企业资讯">
											<i class="icon-pencil"></i>
											</a>
											<a data-trigger="confirm" href="bg/company!delCompany?company.id=${pd.id}" class="btn">
