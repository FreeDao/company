...
<h1 class="page-title">&nbsp; 
				...
				<div class="widget widget-table">
					...
					<div style="margin-bottom: 5px;">
						<a data-trigger="modal" href="bg/recruit!goAddOrEdit" data-title="添加招聘信息" class="btn btn-primary"><i class="icon-plus" ></i>添加</a>
					</div>
								...
								<table class="table table-bordered table-hover">
									...
									<c:forEach items="${pu.data }" var="pd">
										<tr>
											...
											<td>${pd.tel }</td>
											<td>
											<a class="btn" data-trigger="modal" href="bg/recruit!goAddOrEdit?recruit.id=${pd.id }" data-title="修改招聘信息">
											<i class="icon-pencil"></i>
											</a>
											<a data-trigger="confirm" href="bg/recruit!delRecruit?recruit.id=${pd.id}" class="btn">
