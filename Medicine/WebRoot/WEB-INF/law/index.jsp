...
<h1 class="page-title">&nbsp; 
				...
				<div class="widget widget-table">
					...
					<div style="margin-bottom: 5px;">
						<a data-trigger="modal" href="bg/law!goAddOrEdit" data-title="添加法律法规信息" class="btn btn-primary"><i class="icon-plus" ></i>添加</a>
					</div>
								...
								<table class="table table-bordered table-hover">
									...
									<c:forEach items="${pu.data }" var="pd">
										<tr>
											...
											<td>${pd.source }</td>
											<td>
											<a class="btn" data-trigger="modal" href="bg/law!goAddOrEdit?law.id=${pd.id }" data-title="修改法律法规资讯">
											<i class="icon-pencil"></i>
											</a>
											<a data-trigger="confirm" href="bg/law!delLaw?law.id=${pd.id}" class="btn">
