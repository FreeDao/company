...
<html>
  ...
  <body>
  <br/>
	<form id="edit-profile" class="form-horizontal" enctype="multipart/form-data" action="bg/product!addOrEdit" method="post" >
		<input name="product.top" value="0" type="hidden"/>
		<fieldset>
			...
			<div class="control-group">											
				...
				<div class="controls">
					<input type="text" class="input-medium" name="product.title" id="title" value="${product.title }"/>
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="product.quotation" id="quotation" >${product.quotation }</textarea>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="product.content" id="ct">${product.content }</textarea>
					<span class="help-inline"></span>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			
			<c:if test="${product.logo != null && product.logo != '' }">
				<div class="control-group">											
					<label class="control-label" >历史图片</label>
					<div class="controls">
						<img alt="" src="${product.logo }" width="80px" height="80px" class="img-polaroid">
					</div> <!-- /controls -->				
				</div> <!-- /control-group -->
			</c:if>
