					...
					<div style="margin-top: 5px;">
						...
						<div class="widget widget-table">
							...
							<div style="margin-bottom: 5px;">
								<a data-toggle="modal" href="bg/information!goAddOrEdit"
										...
										<c:forEach items="${pu.data }" var="pd">
											<tr>
												...
												<c:if test="${pd[7] == 0 }">
													...
													onclick="addTop('bg/information!topToggle?information.id=${pd[0]}')">置顶
														 </a>
												</c:if>
												 <c:if test="${pd[7] != 0 }">
													<a class="btn btn-info"
													onclick="delTop('bg/information!topToggle?information.id=${pd[0]}')">取消置顶
														 </a>
												</c:if>
												</td>
											</tr>
