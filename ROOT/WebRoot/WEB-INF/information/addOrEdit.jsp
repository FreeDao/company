	...
	<form id="edit-profile" class="form-horizontal" enctype="multipart/form-data" action="bg/information!addOrEdit" method="post" >
		...
		<fieldset>
			...
			<div class="control-group">											
				...
				<div class="controls">
					<input type="text" class="input-medium" name="information.title" id="title" value="${information.title }"/>
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="information.quotation" id="quotation" >${information.quotation }</textarea>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="information.content" id="ct">${information.content }</textarea>
					<span class="help-inline"></span>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			...
			<c:if test="${information.logo != null && information.logo != '' }">
				<div class="control-group">											
					...
					<div class="controls">
						<img alt="" src="${information.logo }" width="80px" height="80px" class="img-polaroid">
					</div> <!-- /controls -->				
				</div> <!-- /control-group -->
			</c:if>
