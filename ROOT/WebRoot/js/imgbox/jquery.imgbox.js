...
;(function($) {
	...
	var elem, opts, preloader, orig_pos, final_pos, busy = false, nr, zindex = 10500, titleh = 0, shadow = 20, margin = 20, fx = $.extend($('<div/>')[0], { prop: 0 });
	...
	function zoomOut() {
		...
		if (opts.speedOut > 0) {
			...
			setTimeout(function() {
				$('#imgbox-wrap-' + nr).css('z-index', 10500);
				$('#imgbox-bg-' + nr).css('z-index', 10500);
		    }, opts.speedOut * 0.5);
	...
	function _clean_up() {
        ...
        zindex = zindex > 10500 ? zindex - 2 : 10500;
