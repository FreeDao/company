...
<div class="title" ><a>当前位置：${position }</a></div>
<div style="margin-top:10px;">
<div style="width:982px; height:203px; margin:0px auto; "><img src="../images/newspic.jpg" width="982" height="203" /></div>
<div class="newstitle">
<div class="quanwen">全文内容</div>
<div style="margin-left:10px;"><span class="quanwen">日期：${object.addTime }</span></div>
</div>
<div style="width:982px; height:1px; background-color:#999; margin:0px auto;"></div>
<div class="Text">
<div class="Market"><a>${object.title }</a></div>
<div class="zhengwen"><a>${object.content }</a></div>
</div>
