...
public class NewsService {
	...
	public List<Top> findTop(Integer id) {
		// TODO Auto-generated method stub
		String hql = "from Top t where t.parentId = "+id+" and t.type = 1";
	 ...
	 * @return
	 */
	public PageUtil findNewsList(Integer pageNow, Integer limit) {
		// TODO Auto-generated method stub
		String sql = "select i.*,(SELECT count(*) from top t where t.parentId = i.id and t.type = 1) isTop from news i ORDER BY isTop desc,i.addTime desc";
