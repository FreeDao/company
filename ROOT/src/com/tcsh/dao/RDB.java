...
@Transactional("remotTransactionManager")
@Component("rdb")
public class RDB {

	private Session session;
	@Autowired
	@Resource(name="remotSessionFactory")
	private SessionFactory remoteSessionFactory;

	private void init() {
		session = remoteSessionFactory.getCurrentSession();
	}
	...
	public List<?> findHqlList(String hql,Integer pageNow,Integer limit){
		List<?> objects = null;
		try {
			if( null == limit ){
				limit = 10;
