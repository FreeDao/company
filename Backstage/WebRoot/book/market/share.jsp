<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
 ...
 <html>
  ...
  <script src="book/market/share.js" type="text/javascript"></script>
   </head>
   <body >
       <div id="datagrid"></div>  
           ...
           <div style="padding: 20px 20px 40px 80px;">
            ...
            <table>
                <tr>
                    <td>  城市名称：</td>
                    <td> <input name="city"  class="easyui-validatebox"     data-options="required:true" style="width: 300px;" /></td>
                </tr>
                <tr>
                    <td>  首字母：</td>
                    <td> <input  name="cityWord" class="easyui-validatebox" data-options="required:true"  style="width: 300px;" /></td>
                </tr>
            </table>
            </form>
        </div>
