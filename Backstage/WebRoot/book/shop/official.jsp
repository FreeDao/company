<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
 ...
 <html>
  ...
  <script src="book/shop/official.js" type="text/javascript"></script>
   </head>
   <body >
       <div id="datagrid"></div>  
           ...
           <div style="padding: 20px 20px 40px 80px;">
            ...
            <table>
                <tr>
                 ...
                 <tr>
                    <td>  份数：</td>
                    <td> <input name="number" class="easyui-numberbox"  data-options="required:true"  style="width: 300px;" /></td>
                </tr>                
                 <tr>
                    <td>  需要积分：</td>
                    <td> <input  name="integral"  style="width: 300px;" class="easyui-numberbox"  data-options="required:true"  /></td>
                </tr>    
                <tr>
                    <td>  商品简介：</td>
           ...
           <div style="padding: 20px 20px 40px 80px;">
            ...
            <table>
                <tr>
                 ...
                 <tr>
                    <td>  份数：</td>
                    <td> <input name="number"  class="easyui-validatebox" data-options="required:true" class="easyui-numberbox"   style="width: 300px;" /></td>
                </tr>                
                 <tr>
                    <td>  需要积分：</td>
                    <td> 
                    <input type="hidden" name="id">
                    <input  name="integral"  style="width: 300px;" data-options="required:true" class="easyui-numberbox"  /></td>
                </tr>    
                <tr>
                    <td>  商品简介：</td>
                    <td> <input  name="bife" type="text" style="width: 300px;height: 200px;" data-options="required:true"  /></td>
