...
//表格开始
	 datagrid=$('#datagrid').datagrid({
        ...
        iconCls: 'icon-save',
        methord: 'post',
        url: '../Backstage/news/selVideoBackstage.action',
        pageSize: 20,
        pageList:[5,10,15,20],
        frozenColumns: [[
        ...
        columns: [[
					...
					{ field: 'iphone', title: '电话', width: 150,align:'center'},
					{ field: 'price', title: '价格', width: 150,align:'center'},
					{ field: 'bife', title: '房屋描述', width: 150,align:'center'},
					{ field: 'traffic', title: '交通状况', width: 150,align:'center'},
					{ field: 'quarters', title: '小区', width: 150,align:'center'}
				]],
        fit:true,
        pagination: true,
        rownumbers: true,
...
//批量删除开始
	  if (num >0) { 
		  $.messager.confirm('提示信息', '您确认要删除吗?', function (data) {
	            if (data) {
	                $.ajax({
	                    url: '../Backstage/news/delVideoBackstage.action',
	                    type: 'post',
	                    data: {items: ids.join(',')},	  
	                    success: function (data) {
	                    datagrid.datagrid('reload');
