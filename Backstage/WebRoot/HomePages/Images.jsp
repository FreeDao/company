...
-->
  ...
  <tr>
  	<td width="100%" height="30"><a href="../era/System/addPages.action">新增</a></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">查看</div></td>
        ...
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21"><a href="../era/System/delProduct.action?id=${d.id}">删除<a></div></td>
      </tr>
      </s:iterator>
    </table></td>
  </tr>
  ...
  <s:if test="%{pagenum==1}">上一页</s:if>
				...
				<a href="../era/System/selProduct.action?pagenum=${pagenum-1}&id=${idOne}">上一页</a>
				</s:elseif>
				...
				<s:if test="%{pageCount>pagenum}">
					<a href="../era/System/selProduct.action?pagenum=${pagenum+1}&id=${idOne}">
					下一页 </a>
				</s:if>
