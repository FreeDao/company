...
-->
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1">详细便民信息列表</span></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
  ...
  <tr>
  	<td width="100%" height="30"><a href="../City/System/addPage.action">新增</a></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="8%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">经度</span></div></td>
        <td width="4%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">纬度</span></div></td>
      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${d[0].name}</div></td>
		  <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19">${d[0].phone}</span></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${d[0].log}</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${d[0].dim}</div></td>
        ...
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21"><a href="../City/System/delConvenientDetail.action?id=${d[0].id}">删除<a>|<a href="../City/System/updaePage.action?id=${d[0].id}">修改<a></div></td>
      </tr>
      </s:iterator>
    </table></td>
  </tr>
  ...
  <s:if test="%{pagenum==1}">上一页</s:if>
				...
				<a href="../City/System/selConvenientDetail.action?pagenum=${pagenum-1}">上一页</a>
				</s:elseif>
				<s:form name="form5" action="../City/System/selConvenientDetail.action" namespace="/Web" method="post" theme="simple" style="display:inline-block;">
				...
				<s:if test="%{pageCount>pagenum}">
					<a href="../City/System/selConvenientDetail.action?pagenum=${pagenum+1}">
					下一页 </a>
				</s:if>
