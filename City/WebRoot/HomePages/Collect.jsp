...
-->
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 收藏信息列表</span></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="8%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">收藏人</span></div></td>
      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21"><a href="../City/System/delCollect.action?id=${d[0]}">删除<a></div></td>
      </tr>
      </s:iterator>
    </table></td>
  </tr>
  ...
  <s:if test="%{pagenum==1}">上一页</s:if>
				...
				<a href="../City/System/selCollect.action?pagenum=${pagenum-1}">上一页</a>
				</s:elseif>
				<s:form name="form5" action="../City/System/selCollect.action" namespace="/Web" method="post" theme="simple" style="display:inline-block;">
				...
				<s:if test="%{pageCount>pagenum}">
					<a href="../City/System/selCollect.action?pagenum=${pagenum+1}">
					下一页 </a>
				</s:if>
