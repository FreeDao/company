...
-->
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1">便民信息列表</span></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
  ...
  <tr>
  	...
  	<s:form id="login" action="../City/System/selConvenient.action" method="post">
    	<tr>
    	<td width="10%" height="30"><a href="../City/System/addConvenientPage.action">新增</a></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><img src="${d[0].imgUrl}" width="100" height="100"></div></td>
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21"><a href="../City/System/delConvenient.action?id=${d[0].id}">删除</a></div></td>
      </tr>
      </s:iterator>
    </table></td>
  </tr>
  ...
  <s:if test="%{pagenum==1}">上一页</s:if>
				...
				<a href="../City/System/selConvenient.action?pagenum=${pagenum-1}&name=${nameOne}">上一页</a>
				</s:elseif>
				<s:form name="form5" action="../City/System/selConvenient.action" namespace="/Web" method="post" theme="simple" style="display:inline-block;">
				...
				<s:if test="%{pageCount>pagenum}">
					<a href="../City/System/selConvenient.action?pagenum=${pagenum+1}&name=${nameOne}">
					下一页 </a>
				</s:if>
