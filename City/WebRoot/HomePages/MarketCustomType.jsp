...
document.getElementById('popIframe').style.display='none';
  ...
  <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1">行业类别列表</span></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
   ...
   <tr>
  	...
  	<s:form id="login" action="../City/System/selMarketCustomType.action" method="post">
    	<tr>
    	<td width="10%" height="30"><a href="../City/System/addMarketCustomTypePage.action">新增</a></td>
    	<td width="90%" height="30">
        <div align="center">
      	 类型:<input name="typeName" type="text" /><input name="title" type="submit" value="搜索" />
        </div>
        </td></tr>
         </s:form>
    </table></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="8%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">城市名称</span></div></td>
        <td width="8%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">市场名称</span></div></td>
        <td width="9%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">类型名称</span></div></td>
      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${d[2].cityName}</div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${d[1].type}</div></td>
		  <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19">${d[0].name}</span></div></td>
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21"><a href="../City/System/addMarketCustomTypePage.action?id=${d[0].id}">修改<a>|<a href="../City/System/delMarketCustomType.action?id=${d[0].id}">删除<a></div></td>
      </tr>
      </s:iterator>
    </table></td>
  </tr>
  ...
  <s:if test="%{pagenum==1}">上一页</s:if>
				...
				<a href="../City/System/selMarketCustomType.action?pagenum=${pagenum-1}">上一页</a>
				</s:elseif>
				<s:form name="form5" action="../City/System/selMarketCustomType.action" namespace="/Web" method="post" theme="simple" style="display:inline-block;">
				...
				<s:if test="%{pageCount>pagenum}">
					<a href="../City/System/selMarketCustomType.action?pagenum=${pagenum+1}">
					下一页 </a>
				</s:if>
