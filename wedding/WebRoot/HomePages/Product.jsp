...
<html>
  ...
  <body>
     <div id="all3">
                        <div class="va">
                        <div class="cc"><div class="pt">用户管理</div></div>
                        <div class="ee">
                        	<form action="../JunKeting/System/selUserAll.action" method="post">
                            <table>
                                <tr align="center">
                                    <td>用户昵称：<input type="text" name="name"></td>
                                </tr>
                                <tr>
                       ...
                       <div class="kk">
                            <table border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td align="center"><img src="${d.head}"/></td>
                                    <td align="center"><a href="../JunKeting/System/delUser.action?id=${d.id}">删除</a></td>
                                </tr>
                                </s:iterator>
                            </table>
                        </div>
                         <div class="aa" align="center">
                            <s:if test="%{pagenum==1}">上一页</s:if>
								...
								<a href="../JunKeting/System/selUserAll.action?pagenum=${pagenum-1}&name=${nameOne}">上一页</a>
								</s:elseif>
								<s:form name="form5" action="../JunKeting/System/selUserAll.action" namespace="/Web" method="post" theme="simple" style="display:inline-block;">
								...
								<s:if test="%{pageCount>pagenum}">
									<a href="../JunKeting/System/selUserAll.action?pagenum=${pagenum+1}&name=${nameOne}">
									下一页 </a>
								</s:if>
