  ...
  <body>
   ...
   <script type="text/javascript">
   		function updatePass()
   		{
   			...
   			if(opass == "")
   			{
   				$(".opass").html('<label  style="color: red;"><img src="../JunKeting/images/error.jpg">旧密码为空</label>');
   				return false;
   			}
   			else
   			{
   				$(".opass").html('<img src="../JunKeting/images/right.jpg">');
   			}
   			if(npass1 == "")
   			{
   				$(".npass1").html('<label  style="color: red;"><img src="../JunKeting/images/error.jpg">新密码为空</label>');
   				return false;
   			}
   			else
   			{
   				$(".npass1").html('<img src="../JunKeting/images/right.jpg">');
   			}
   			if(npass2 == "")
   			{
   				$(".npass2").html('<label  style="color: red;"><img src="../JunKeting/images/error.jpg">确认密码为空</label>');
   				return false;
   			}
   			else
   			{
   				$(".npass2").html('<img src="../JunKeting/images/right.jpg">');
   			}
   			if(npass2 != npass1)
   			{
   				$(".npass2").html('<label  style="color: red;"><img src="../JunKeting/images/error.jpg">新密码和确认密码不一样</label>');
   				return false;
   			}
   			else
   			{
   			...
   			if(opass == npass1)
   			{
   				$(".npass2").html('<label  style="color: red;"><img src="../JunKeting/images/error.jpg">新密码和旧密码不能一样</label>');
   				return false;
   			}
   			$.ajax({
				type: "post",
