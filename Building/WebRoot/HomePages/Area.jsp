...
<body>
	<div id="all3">
		<div class="va">
			<div class="cc">
				<div class="pt">所有地区</div>
			</div>
			<div class="ee">
				<form action="../Building/System/selArea.action"
					method="post">
					<table>
						<tr align="center">
							<td>地区名称：<input type="text" name="area"></td>
						</tr>
						<tr>
		...
		<div class="ce">地区信息</div>
		<div class="va1">
			<div>
				<a href="../Building/System/addAreaPage.action">添加地区</a>
			</div>
			<div class="kk">
				<table border="0" cellpadding="0" cellspacing="0">
					<tr>
							...
							<td width="9%" height="20" bgcolor="d3eaef" class="STYLE6"><div
									align="center">
									<span class="STYLE10">城市名称</span>
								</div>
							</td>
							<td width="8%" height="20" bgcolor="d3eaef" class="STYLE6"><div
									align="center">
									<span class="STYLE10">地区名称</span>
								</div>
							</td>
						...
						<s:iterator value="area_list" var="l">
							 <tr>
								<td height="20" bgcolor="#FFFFFF" class="STYLE19"><div
										align="center" id="divID">${l[0].id}</div>
								</td>
								<td height="20" bgcolor="#FFFFFF" class="STYLE19">
									<div align="center">${l[1].cityName }</div>
								</td>
								<td height="20" bgcolor="#FFFFFF" class="STYLE19"><div
										align="center">${l[0].areaRegion}</div>
								</td>
								<td height="20" bgcolor="#FFFFFF">
									<div align="center" class="STYLE21">
										<a href="../Building/System/delArea.action?areaId=${l[0].id}">删除</a>
									</div>
									</td>
							</tr> 
						</s:iterator>
			...
			<div class="aa" align="center">
				...
				<s:elseif test="%{pagenum!=1}">
					<a
						href="../Building/System/selArea.action?pagenum=${pagenum-1}&name=${areaName}">上一页</a>
				</s:elseif>
				<s:form name="form5"
					action="../Building/System/selArea.action" namespace="/Web"
				...
				<s:if test="%{pageCount>pagenum}">
					<a
						href="../Building/System/selArea.action?pagenum=${pagenum+1}&name=${areaName}">
						下一页 </a>
				</s:if>
