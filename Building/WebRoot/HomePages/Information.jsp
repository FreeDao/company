...
<body>
	<div id="all3">
		<div class="va">
			<div class="cc">
				<div class="pt">所有资讯</div>
			</div>
			<div class="ee">
				<form action="../Building/System/selInformation.action"
					method="post">
					<table>
						<tr align="center">
						...
						<tr>
							<td colspan="2" align="center"><input type="submit" value="搜索" id="sou" />
							</td>
						</tr>
					</table>
				</form>
		...
		<div class="ce">资讯信息</div>
		<div class="va1">
			<div>
				<a href="HomePages/AddInformation.jsp">添加资讯</a>
			</div>
			<div class="kk">
				<table border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<s:iterator value="information_list" var="l">
							 <tr>
								...
								<td height="20" bgcolor="#FFFFFF" class="STYLE19">
									<div align="center">${l.title }</div>
								</td>
								<td height="20" bgcolor="#FFFFFF" class="STYLE19"><div
										align="center">${l.addtime}</div>
								</td>
								<td height="20" bgcolor="#FFFFFF" class="STYLE19"><div
										align="center">${l.review}</div>
								</td>
								
								<td height="20" bgcolor="#FFFFFF" class="STYLE19">
									<div align="center">
										<img src="${l.logo}" style="width: 50px; height: 50px;">
									</div>
								</td>
								
								<td height="20" bgcolor="#FFFFFF">
									<div align="center" class="STYLE21">
										<a href="System/delInformation.action?id=${l.id}">删除</a>
									</div>
								</td>
							</tr> 
						</s:iterator>
			...
			<div class="aa" align="center">
				...
				<s:elseif test="%{pagenum!=1}">
					<a
						href="../Building/System/selInformation.action?pagenum=${pagenum-1}&name=${areaName}">上一页</a>
				</s:elseif>
				<s:form name="form5"
					action="../Building/System/selInformation.action" namespace="/Web"
				...
				<s:if test="%{pageCount>pagenum}">
					<a
						href="../Building/System/selInformation.action?pagenum=${pagenum+1}&name=${areaName}">
						下一页 </a>
				</s:if>
