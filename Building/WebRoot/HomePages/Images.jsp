...
<html>
  ...
  <body>
     <div id="all3">
                    <div class="ce">所有图片</div>
                    <div class="va1">
                    <div>
						<a href="../Building/System/addImagePage.action">添加图片</a>
					</div>
                       <div class="kk">
                            <table border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td align="center"><a href="../Building/System/delImage.action?id=${d.id}">删除</a></td>
                                </tr>
                                </s:iterator>
                            </table>
                        </div>
                         <div class="aa" align="center">
                            <s:if test="%{pagenum==1}">上一页</s:if>
								...
								<a href="../Building/System/selImageAll.action?pagenum=${pagenum-1}">上一页</a>
								</s:elseif>
								<s:form name="form5" action="../Building/System/selImageAll.action" namespace="/Web" method="post" theme="simple" style="display:inline-block;">
								...
								<s:if test="%{pageCount>pagenum}">
									<a href="../Building/System/selImageAll.action?pagenum=${pagenum+1}">
									下一页 </a>
								</s:if>
