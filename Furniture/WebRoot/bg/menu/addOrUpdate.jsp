                        ...
                        <div class="container">
                            ...
                            <input name="menu.id" value="${menu.id }" type="hidden">
                                <div class="span12 field-box">
                                    ...
                                    <span class="alert-msg " style="color: red;display: none;" ><i class="icon-remove-sign"></i>请填写菜单名称</span>
                                </div>
                                <div class="span12 field-box error">
                                    <label>菜单连接:</label>
                                    <input class="span9" type="text" name="menu.url" value="${menu.url }" placeholder="选填" />
                                </div>
                                <div class="span12 field-box">
                                    <label>菜单图标:</label>
                                    <input class="span9" type="text" name="menu.icon" value="${menu.icon }" placeholder="选填" />
                                </div>
                                <div class="span12 field-box">
                                    <label>菜单排序:</label>
                                    ...
                                    <div class="ui-select span5">
                                        <select name="menu.level">
                                        	<c:forEach begin="1" end="5" step="1" var="i">
                                        		<c:choose>
													<c:when test="${menu.level == i }"><option value="${i }" >${i } </option></c:when>       
                                ...
                                --%><div class="span11 field-box actions">
                                    <input type="button" class="btn-flat primary" value="提 交" onclick="validSubmit('myForm','name')" />
                                    <span>或者</span>
                                    <input type="button" value="返回" class="btn-flat default" onclick="window.location.href='${url }'" />
                                </div>
                            </form>
                        </div>
                    </div>
