...
public class Seller {
	...
	@Column
	private Double productPreference;
	@Transient
	...
	public String getProductUnit() {
		return null == productUnit ? "" : productUnit;
	...
	public Double getProductPrice() {
		return null == productPrice ? 0 : productPrice;
	}
	public void setProductPrice(Double productPrice) {
		this.productPrice = productPrice;
	}
	public Double getProductPreference() {
		return null == productPreference ? 0 : productPreference;
	}
	public void setProductPreference(Double productPreference) {
