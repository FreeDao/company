...
<link type="text/css" href="${pageContext.request.contextPath}/css/center.css" rel="stylesheet" />
  ...
  <ul class="breadcrumb" style="border: 1px;border-color: #E8E8E8;border-style:solid;">
	  ...
	  <li class="active">商户图片</li>
  </ul>
  
  <fieldset style="width: 98%;" >
	<legend>查询条件</legend>
	<form class="form-search" action="../MarketManager/System/selImages.action" method="post">
	商户标题：
	...
	<a href="../MarketManager/System/addImages.action">添加商户图片</a>
	</fieldset>
                            ...
                            <tr class="info">
                                ...
                                <tr>
                                    ...
                                    <td align="center"><img src="${d[0].imgUrl}" height="40" width="40"></td>
                                    <td align="center">${d[1].titile}</td>
                                    <s:if test="#session.root==1">
                         ...
                         <div align="center">
                         <s:form name="form5" action="../MarketManager/System/selImages.action" namespace="/Web" method="post" theme="simple" style="display:inline-block;">
                         <ul class="pager">
                            <s:if test="%{pagenum==1}"><li>上一页</li></s:if>
								<s:elseif test="%{pagenum!=1}">
								<li><a href="../MarketManager/System/selImages.action?pagenum=${pagenum-1}&name=${nameOne}">上一页</a></li>
								</s:elseif>
								<li>
								第<s:textfield type="text" name="pagenum" id="textfield" cssClass="pagetext" size="2" style="width:20px;"></s:textfield>
								...
								<s:if test="%{pageCount>pagenum}">
									<li><a href="../MarketManager/System/selImages.action?pagenum=${pagenum+1}&name=${nameOne}">
									下一页 </a></li>
								</s:if>
