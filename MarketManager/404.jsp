...
<style>
body{background:url(../AgentSystem/images/ss.png) center 200px no-repeat;}
...
function num()
{
 ...
 if(nn==0){
   clearInterval(mess);
	 window.location="http://china.pjt.net.cn";
	 }
	 else{nn --;}
}
function SetNum()
...
<body>
<div class="content">
<div><img src="../AgentSystem/images/ss.png" width="117" height="48"/></div>
<div class="ts"><h2>发生错误!</h2><br/><br/><br/><br/><span id="nuber">5</span>秒内系统将<br/>
　　自动返回首页</div>
<div class="re"><a href="HTTP://www.pjt.net.cn"><img src="images/404-re.gif" style="border:0 none;"/></a></div>
</div>
