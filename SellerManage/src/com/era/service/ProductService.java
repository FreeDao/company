...
public interface ProductService 
{
	 ...
	 * @return
	 */
	public List<Object> selProduct(String name,String sellerid,int pageNo, int pageSize);
	/**
	 * 查询产品的图片
	 * @param id
	 * @return
	 ...
	 * @return
	 */
	public List<Object> selImagesOrr(String name,String sellerid,int pageNo, int pageSize);
	/**
	 * 删除图片
	 * @return
	 */
