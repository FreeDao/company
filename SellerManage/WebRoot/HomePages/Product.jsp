...
<html>
  ...
  <body>
     <div id="all3">
                        <div class="va">
                        <div class="cc"><div class="pt">产品管理</div></div>
                        <div class="ee">
                        	<form action="../SellerManage/System/selProductNum.action" method="post">
                            <table>
                                <tr align="center">
                    ...
                    <div class="ce">产品管理</div>
                    <div class="va1">
                    <div><a href="../SellerManage/System/addProductPage.action">添加产品</a></div>
                       <div class="kk">
                            <table border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td align="center"><a href="../SellerManage/System/selProductImage.action?id=${d[0].id}">查看</a></td>
                                    <td align="center">${d[1].titile}</td>
                                    <td align="center"><a href="../SellerManage/System/updateProductPage.action?id=${d[0].id}">修改</a>|<a href="../SellerManage/System/delProduct.action?id=${d[0].id}">删除</a></td>
                                </tr>
                                </s:iterator>
                            </table>
                        </div>
                         <div class="aa" align="center">
                            <s:if test="%{pagenum==1}">上一页</s:if>
								...
								<a href="../SellerManage/System/selProductNum.action?pagenum=${pagenum-1}&name=${nameOne}">上一页</a>
								</s:elseif>
								<s:form name="form5" action="../SellerManage/System/selProductNum.action" namespace="/Web" method="post" theme="simple" style="display:inline-block;">
								...
								<s:if test="%{pageCount>pagenum}">
									<a href="../SellerManage/System/selProductNum.action?pagenum=${pagenum+1}&name=${nameOne}">
									下一页 </a>
								</s:if>
