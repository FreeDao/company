  ...
  <body>
    <div id="all3">
             <div class="va">
                        ...
                        <div class="ee">
                        	<form action="../SellerManage/System/selProductImage.action" method="post">
                            <table>
                                <tr align="center">
                    ...
                    <div class="va1">
                    <div><a href="../SellerManage/System/addProductImagesPage.action?id=${ide}">添加图片</a></div>
                       <div class="kk">
                         ...
                         <div class="aa" align="center">
                            <s:if test="%{pagenum==1}">上一页</s:if>
								...
								<a href="../SellerManage/System/selProductImage.action?pagenum=${pagenum-1}&name=${nameOne}&id=${ide}">上一页</a>
								</s:elseif>
								<s:form name="form5" action="../SellerManage/System/selProductImage.action" namespace="/Web" method="post" theme="simple" style="display:inline-block;">
								...
								<s:if test="%{pageCount>pagenum}">
									<a href="../SellerManage/System/selProductImage.action?pagenum=${pagenum+1}&name=${nameOne}&id=${ide}">
									下一页 </a>
								</s:if>
