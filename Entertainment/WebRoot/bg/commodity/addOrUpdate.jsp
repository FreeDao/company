						...
						<div class="span9 with-sidebar">
							<div class="container">
								...
								<div id="info" class="myTag">
									...
									<div class="span12 field-box">
										<label>价格:</label> <input id="price" class="span9"
											type="text" name="commodity.price" value="${commodity.price }"
											placeholder="选填，只能填写数字" onkeyup="this.value=this.value.replace(/\D/g,'')" />
									</div>
									
									<div class="span12 field-box">
										<label>数量:</label> <input id="num" class="span9"
											type="text" name="commodity.num" value="${commodity.num }"
											placeholder="选填，只能填写数字" onkeyup="this.value=this.value.replace(/\D/g,'')" />
									</div>
									
									<div class="span12 field-box">
										<label>优惠信息:</label> <input id="preference" class="span9"
