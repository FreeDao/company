...
<link href="${pageContext.request.contextPath}/css/scojs.css" rel="stylesheet" /> 
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/sco.message.js"></script>
