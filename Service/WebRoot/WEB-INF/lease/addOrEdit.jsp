...
<html>
  ...
  <body>
  <br/>
	<form id="edit-profile" class="form-horizontal" enctype="multipart/form-data" action="bg/lease!addOrEdit" method="post" >
		<fieldset>
			<input type="hidden" name="lease.id" value="${lease.id }"/>
			
			<div class="control-group">											
				<label class="control-label" for="title">标题</label>
				<div class="controls">
					<input type="text" class="input-medium" name="lease.title" id="title" value="${lease.title }"/>
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="lease.quotation" id="quotation" >${lease.quotation }</textarea>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="lease.addr" id="addr" >${lease.addr }</textarea>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="lease.tel" id="tel" >${lease.tel }</textarea>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			...
			<div class="control-group">											
				...
				<div class="controls">
					<select name="lease.level">
						<c:choose>
							<c:when test="${lease.level == 1}">
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="lease.content" id="ct">${lease.content }</textarea>
					<span class="help-inline"></span>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			
			<c:if test="${lease.logo != null && lease.logo != '' }">
				<div class="control-group">											
					<label class="control-label" >历史图片</label>
					<div class="controls">
						<img alt="" src="${lease.logo }" width="80px" height="80px" class="img-polaroid">
					</div> <!-- /controls -->				
				</div> <!-- /control-group -->
			</c:if>
