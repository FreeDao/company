					...
					<div style="margin-top: 5px;">
						...
						<div class="widget widget-table">
							...
							<div style="margin-bottom: 5px;">
								<a data-toggle="modal" href="bg/entertainment!goAddOrEdit"
										...
										<c:forEach items="${pu.data }" var="pd">
											<tr>
												...
												<td><a data-toggle="modal"
													href="bg/entertainment!goAddOrEdit?entertainment.id=${pd.id }"
													data-target="#myModal" class="btn"><i
														class="icon-pencil"></i> </a> <a class="btn"
													onclick="del('bg/entertainment!delEntertainment?entertainment.id=${pd.id}')"><i
