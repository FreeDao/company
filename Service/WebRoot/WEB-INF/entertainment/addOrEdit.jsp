...
<html>
  ...
  <body>
  <br/>
	<form id="edit-profile" class="form-horizontal" enctype="multipart/form-data" action="bg/entertainment!addOrEdit" method="post" >
		<fieldset>
			<input type="hidden" name="entertainment.id" value="${entertainment.id }"/>
			
			<div class="control-group">											
				<label class="control-label" for="title">标题</label>
				<div class="controls">
					<input type="text" class="input-medium" name="entertainment.title" id="title" value="${entertainment.title }"/>
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="entertainment.quotation" id="quotation" >${entertainment.quotation }</textarea>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="entertainment.addr" id="addr" >${entertainment.addr }</textarea>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="entertainment.tel" id="tel" >${entertainment.tel }</textarea>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			...
			<div class="control-group">											
				...
				<div class="controls">
					<select name="entertainment.level">
						<c:choose>
							<c:when test="${entertainment.level == 1}">
							...
							<c:when test="${entertainment.level == 2}">
							...
							<c:when test="${entertainment.level == 3}">
								<option value="1">1</option>
								<option value="2">2</option>
							...
							<c:when test="${entertainment.level == 4}">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
							...
							<c:when test="${entertainment.level == 5}">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="4">4</option>
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="entertainment.content" id="ct">${entertainment.content }</textarea>
					<span class="help-inline"></span>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			
			<c:if test="${entertainment.logo != null && entertainment.logo != '' }">
				<div class="control-group">											
					<label class="control-label" >历史图片</label>
					<div class="controls">
						<img alt="" src="${entertainment.logo }" width="80px" height="80px" class="img-polaroid">
					</div> <!-- /controls -->				
				</div> <!-- /control-group -->
			</c:if>
