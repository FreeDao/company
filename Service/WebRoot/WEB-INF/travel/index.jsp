			...
			<div class="row">
				...
				<div class="span9">
					<div style="margin-top: 5px;">
						<h1 class="page-title">&nbsp; 旅游管理</h1>

						<div class="widget widget-table">

							<div style="margin-bottom: 5px;">
								<a data-toggle="modal" href="bg/travel!goAddOrEdit"
										...
										<c:forEach items="${pu.data }" var="pd">
											<tr>
												...
												<td><a data-toggle="modal"
													href="bg/travel!goAddOrEdit?travel.id=${pd.id }"
													data-target="#myModal" class="btn"><i
														class="icon-pencil"></i> </a> <a class="btn"
													onclick="del('bg/travel!delTravel?travel.id=${pd.id}')"><i
