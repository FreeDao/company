...
<html>
  ...
  <body>
  <br/>
	<form id="edit-profile" class="form-horizontal" enctype="multipart/form-data" action="bg/hairdressing!addOrEdit" method="post" >
		<fieldset>
			<input type="hidden" name="hairdressing.id" value="${hairdressing.id }"/>
			
			<div class="control-group">											
				<label class="control-label" for="title">标题</label>
				<div class="controls">
					<input type="text" class="input-medium" name="hairdressing.title" id="title" value="${hairdressing.title }"/>
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="hairdressing.quotation" id="quotation" >${hairdressing.quotation }</textarea>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="hairdressing.addr" id="addr" >${hairdressing.addr }</textarea>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="hairdressing.tel" id="tel" >${hairdressing.tel }</textarea>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			...
			<div class="control-group">											
				...
				<div class="controls">
					<select name="hairdressing.level">
						<c:choose>
							<c:when test="${hairdressing.level == 1}">
							...
							<c:when test="${hairdressing.level == 2}">
							...
							<c:when test="${hairdressing.level == 3}">
								<option value="1">1</option>
								<option value="2">2</option>
							...
							<c:when test="${hairdressing.level == 4}">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
							...
							<c:when test="${hairdressing.level == 5}">
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
								<option value="4">4</option>
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="hairdressing.content" id="ct">${hairdressing.content }</textarea>
					<span class="help-inline"></span>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			
			<c:if test="${hairdressing.logo != null && hairdressing.logo != '' }">
				<div class="control-group">											
					<label class="control-label" >历史图片</label>
					<div class="controls">
						<img alt="" src="${hairdressing.logo }" width="80px" height="80px" class="img-polaroid">
					</div> <!-- /controls -->				
				</div> <!-- /control-group -->
			</c:if>
