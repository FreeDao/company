...
<html>
  ...
  <body>
  <br/>
	<form id="edit-profile" class="form-horizontal" enctype="multipart/form-data" action="bg/cate!addOrEdit" method="post" >
		<fieldset>
			...
			<div class="control-group">											
				...
				<div class="controls">
					<input type="text" class="input-medium" name="cate.title" id="title" value="${cate.title }"/>
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="cate.quotation" id="quotation" >${cate.quotation }</textarea>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="cate.addr" id="addr" >${cate.addr }</textarea>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="cate.tel" id="tel" >${cate.tel }</textarea>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			...
			<div class="control-group">											
				...
				<div class="controls">
					<select name="cate.level">
						<c:choose>
							<c:when test="${cate.level == 1}">
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="cate.content" id="ct">${cate.content }</textarea>
					<span class="help-inline"></span>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			
			<c:if test="${cate.logo != null && cate.logo != '' }">
				<div class="control-group">											
					<label class="control-label" >历史图片</label>
					<div class="controls">
						<img alt="" src="${cate.logo }" width="80px" height="80px" class="img-polaroid">
					</div> <!-- /controls -->				
				</div> <!-- /control-group -->
			</c:if>
