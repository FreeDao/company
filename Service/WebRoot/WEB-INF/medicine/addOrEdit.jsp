...
<html>
  ...
  <body>
  <br/>
	<form id="edit-profile" class="form-horizontal" enctype="multipart/form-data" action="bg/medicine!addOrEdit" method="post" >
		<fieldset>
			...
			<div class="control-group">											
				...
				<div class="controls">
					<input type="text" class="input-medium" name="medicine.title" id="title" value="${medicine.title }"/>
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="medicine.quotation" id="quotation" >${medicine.quotation }</textarea>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="medicine.addr" id="addr" >${medicine.addr }</textarea>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="medicine.tel" id="tel" >${medicine.tel }</textarea>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			...
			<div class="control-group">											
				...
				<div class="controls">
					<select name="medicine.level">
						<c:choose>
							<c:when test="${medicine.level == 1}">
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="medicine.content" id="ct">${medicine.content }</textarea>
					<span class="help-inline"></span>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			
			<c:if test="${medicine.logo != null && medicine.logo != '' }">
				<div class="control-group">											
					<label class="control-label" >历史图片</label>
					<div class="controls">
						<img alt="" src="${medicine.logo }" width="80px" height="80px" class="img-polaroid">
					</div> <!-- /controls -->				
				</div> <!-- /control-group -->
			</c:if>
