...
<html>
  ...
  <body>
  <br/>
	<form id="edit-profile" class="form-horizontal" enctype="multipart/form-data" action="bg/education!addOrEdit" method="post" >
		<fieldset>
			...
			<div class="control-group">											
				...
				<div class="controls">
					<input type="text" class="input-medium" name="education.title" id="title" value="${education.title }"/>
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="education.quotation" id="quotation" >${education.quotation }</textarea>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="education.addr" id="addr" >${education.addr }</textarea>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="education.tel" id="tel" >${education.tel }</textarea>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			...
			<div class="control-group">											
				...
				<div class="controls">
					<textarea name="education.content" id="ct">${education.content }</textarea>
					<span class="help-inline"></span>
				</div> <!-- /controls -->				
			</div> <!-- /control-group -->
			
			<c:if test="${education.logo != null && education.logo != '' }">
				<div class="control-group">											
					<label class="control-label" >历史图片</label>
					<div class="controls">
						<img alt="" src="${education.logo }" width="80px" height="80px" class="img-polaroid">
					</div> <!-- /controls -->				
				</div> <!-- /control-group -->
			</c:if>
