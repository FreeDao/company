					...
					<div style="margin-top: 5px;">
						...
						<div class="widget widget-table">
							...
							<div style="margin-bottom: 5px;">
								<a data-toggle="modal" href="bg/education!goAddOrEdit"
										...
										<c:forEach items="${pu.data }" var="pd">
											<tr>
												...
												<td><a data-toggle="modal"
													href="bg/education!goAddOrEdit?education.id=${pd.id }"
													data-target="#myModal" class="btn"><i
														class="icon-pencil"></i> </a> <a class="btn"
													onclick="del('bg/education!delEducation?education.id=${pd.id}')"><i
