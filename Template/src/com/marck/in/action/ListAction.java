...
public class ListAction extends BaseAction{
	...
	public String seller(){
		try {
			String sort = request.getParameter("sort");//排序方式默认，1：价格最低，2：人气最高。3：评价最高，4：离我最近，5:最新发布
			...
			listService.setSellerList(seller,map,pageNo,pageNum,sort);
	...
	public String commodity(){
		try {
			...
			listService.setCommodityList(commodity,map,pageNo,pageNum,sort);
