...
-->
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21"><a href="../era/System/delCollect.action?id=${d[0]}">删除<a></div></td>
      </tr>
      </s:iterator>
    </table></td>
  </tr>
  ...
  <s:if test="%{pagenum==1}">上一页</s:if>
				...
				<a href="../era/System/selCollect.action?pagenum=${pagenum-1}">上一页</a>
				</s:elseif>
				<s:form name="form5" action="../era/System/selCollect.action" namespace="/Web" method="post" theme="simple" style="display:inline-block;">
				...
				<s:if test="%{pageCount>pagenum}">
					<a href="../era/System/selCollect.action?pagenum=${pagenum+1}">
					下一页 </a>
				</s:if>
