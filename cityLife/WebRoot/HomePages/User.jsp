...
-->
  ...
  <tr>
  	...
  	<s:form id="login" name="" action="../era/System/selUser.action"
		method="post">
    	<tr>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      ...
      <s:iterator value="list" var="d">
        ...
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21"><a href="../era/System/delUser.action?did=${d.id}">删除</a></div></td>
      </tr>
  ...
  <s:if test="%{pagenum==1}">上一页</s:if>
				...
				<a href="../era/System/selUser.action?pagenum=${pagenum-1}&id=${id}&userName=${userNames}">上一页</a>
				</s:elseif>
				<s:form name="form5" action="../era/System/selUser.action" namespace="/Web" method="post" theme="simple" style="display:inline-block;">
				...
				<s:if test="%{pageCount>pagenum}">
					<a href="../era/System/selUser.action?pagenum=${pagenum+1}&id=${id}&userName=${userNames}">
					下一页 </a>
				</s:if>
