...
public class CollectServiceImpl implements CollectService {
	 ...
	 */
	@Override
	public boolean putCollect(Collect collect) {
		boolean flag = false;
		try {
			dao.save(collect);
			flag = true;
	 ...
	 */
	@Override
	public List getCollect(int userId, int pageNo, int pageNum) {
		hql = "from Collect as c where c.userId=" + userId + " order by addtime desc";
		
		List<Collect> list = dao.query(hql, pageNo, pageNum);
