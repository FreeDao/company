...
public interface LotteryDrawService 
{
	 ...
	 * @return
	 */
	public List<Recommend> selRecommend(String name,String cityId,String isIos,String ismend,String typeId,String pageNo,String pageNum);
	/**
	 * 查看应用汇分类
	 * @return
	 */
	 ...
	 * @return
	 */
	public Integer selRecommendNum(String name, String cityId,
			String isIos);
	 ...
	 * @return
	 */
	public LotteryDraw getLotteryDraw(String parameter); 
}
